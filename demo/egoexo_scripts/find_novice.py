# builds the final novice jumpshot take list: proficiency = novice,
...
TARGET_PROFICIENCY = "Novice"
PREFERRED_CAM = "cam01"

OUT_DIR = Path(__file__).resolve().parent
UID_FILE = OUT_DIR / "jumpshot_novice_uids.txt"
META_FILE = OUT_DIR / "jumpshot_novice_takes.json"
